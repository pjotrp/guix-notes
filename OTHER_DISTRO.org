...
Complicated screen, keyboard, power management and wifi setup work
fine. I switch for my daily work seamlessly between work station and
laptop since they have the exact same tools. Reproducibility between
machines is a Guix feature.

I have a few minor niggles I need to improve. I am still seeing locale
error messages (mostly harmless), I would like to improve the fonts
and the external mouse needs to slow down. Also the fan needs improved
regulation.
