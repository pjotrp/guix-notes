...
list. But better is to mail it as it is with something like:

: cat 0001-gnu-patchname.patch |formail -t -I "To: guix-devel@gnu.org" -I "From: pjotr.public12@thebird.nl">mail.msg
: cat test.msg|formail -s mail -t 
...
Note that guix wants one patch per variable.
