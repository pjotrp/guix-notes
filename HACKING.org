...
: cat 0001-*.patch |formail -t -I "To: guix-devel@gnu.org" -I "From: Pjotr Prins <pjotr.public12@thebird.nl>"> mail.msg
: cat ~/tmp/mail.msg|formail -s mail -t ; rm ~/tmp/mail.msg
