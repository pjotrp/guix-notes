...
: export PATH=/home/user/.guix-profile/bin:/usr/bin:/bin
: cd guix
: ./bootstrap
...
as Roel [[https://github.com/UMCUGenetics/guix-additions/blob/master/doc/Deployment.md][documented]].  Restart the new daemon without proot (!)
