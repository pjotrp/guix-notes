...
For the first ever, we have a GNU Guile devroom at FOSDEM on January
30, 2016. The call for talk proposals is open! Important members of
the GNU Guile and GNU Guix community will attend. We are excited
because FOSDEM is one of the most important FOSS conferences and is
...
concerning GNU Guile and applications that use Guile (such as GNU Guix
and Lilypond and Gnucash). In the talks both experienced Guile
