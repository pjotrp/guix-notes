...
renders a cut-and-paste package definition
...
and Guix and make it reproducible.
...
GNU project. But you can still stick in binary blobs if you want. Main
thing is that they need to be in the /gnu/store to be seen at build
time.
