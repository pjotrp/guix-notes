...
* Table of Contents                                                     :TOC:
 ...
 - [[#containerized-run-of-workflow][Containerized run of workflow]]
...
which writes out a container that can be uploaded to docker hup.
...
Docker, though it is still possbible to run Guix created Docker images
