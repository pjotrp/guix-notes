...
I created a jar download for GNU Guix, see
[[GUIX-SIMPLE-PACKAGE.org]]. This was done by creating a Guix channel as
part of the repository. The idea of the package in words is:
