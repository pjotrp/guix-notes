...
multiple versions of Ruby, but over the last years they are showing
their limitations clearly. Every time I need to work with RVM I start
throwing things at my computer. 
...
[[https://github.com/pjotrp/guix-notes/blob/master/INSTALL.org][INSTALL]] document in this repository. There is a binary installer which
...
installation packages from Gem definitions.
