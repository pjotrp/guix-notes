...
explicitly added will *fail*. To check run
...
does not list lower dependencies, such as the Ruby interpreter itself and
...
pull in depending gems separately with gem in the .travis.yml file:
